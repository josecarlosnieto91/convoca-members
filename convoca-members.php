...
register_activation_hook(__FILE__, function (): void {
    ...
    foreach (['shop_manager', 'monitor_actividad'] as $role_name) {
...
add_action('init', [\Convoca\Members\CPT_Miembro::class, 'register']);
add_action('init', [\Convoca\Members\CPT_Registro_Hora::class, 'register']);
add_action('init', [\Convoca\Members\CPT_Proyecto::class, 'register']);
add_action('add_meta_boxes_proyecto', [\Convoca\Members\CPT_Proyecto::class, 'render_metabox']);
add_action('save_post_proyecto', [\Convoca\Members\CPT_Proyecto::class, 'save_metabox']);
...
add_action('bdv_voluntario_aprobado', function (int $user_id): void {

...
class Admin_Proyectos extends \WP_List_Table
{
    public function __construct()
    {
        ...
        add_action('admin_post_bdv_save_proyecto_admin', [$this, 'handle_save_admin']);
        ...
        add_action('admin_bar_menu', [$this, 'customize_admin_bar'], 80);
        add_action('admin_post_bdv_export_proyectos_csv', [$this, 'handle_export_csv']);
    }
    ...
    public function render_editor()
    {
        ...
        $meta = $post_id ? CPT_Proyecto::get_meta($post_id) : [
        ...
        $users = get_users(['role__in' => ['administrator', 'shop_manager', 'monitor']]);

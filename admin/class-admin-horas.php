...
class Admin_Horas extends \WP_List_Table
{
    public function __construct()
    {
        ...
        add_action('admin_post_bdv_save_hours_admin', [$this, 'handle_save_admin']);
        ...
        add_action('admin_post_bdv_export_horas_csv', [$this, 'handle_export_csv']);
    }
    ...
    public function enqueue_assets($hook)
    {
        if (strpos($hook, 'bdv-horas-editor') !== false) {
            wp_enqueue_style('convoca-core', BDV_COMMON_URL . 'assets/css/biodevas-common.css', [], BDV_COMMON_VERSION);
        }
    }
    ...
    public function handle_save_admin()
    {
        ...
        if (in_array($estado_solicitado, ['aprobada', 'rechazada'], true)) {
            $current_user_id  = get_current_user_id();
            $current_user     = wp_get_current_user();
            $current_roles    = $current_user ? (array) $current_user->roles : [];
            ...
            $record_roles = $record_user ? (array) $record_user->roles : [];
    ...
    public function render_editor_page()
    {
        ...
        // Fetch options
        $members = get_posts(['post_type' => 'miembro', 'posts_per_page' => -1, 'post_status' => 'publish', 'orderby' => 'title', 'order' => 'ASC']);
        $projects = get_posts(['post_type' => 'proyecto', 'posts_per_page' => -1, 'post_status' => 'publish', 'orderby' => 'title', 'order' => 'ASC']);
...
<?php
    ...
    public function handle_export_csv(): void
    {
        ...
        if ($filter_proyecto > 0) {
            $args['meta_query'] = [['key' => '_bdv_proyecto_id', 'value' => $filter_proyecto]];
        }
    ...
    public function process_action()
    {
        ...
        if ($record_id && in_array($new_status, ['aprobada', 'rechazada'])) {
            ...
            $volunteer_roles = $volunteer_user ? (array) $volunteer_user->roles : [];

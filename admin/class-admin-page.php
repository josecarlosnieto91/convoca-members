...
class Admin_Page
{
    ...
    public function __construct()
    {
        ...
        add_action('admin_post_bdv_export_members_pdf', [$this, 'handle_export_members_pdf']);
    }
    ...
    public function register_menu(): void
    {
        ...
        add_submenu_page(
            ...
            [new Admin_Member_Editor(), 'render']
        );
    ...
    public function dashboard_widget(): void
    {
        wp_add_dashboard_widget(
            ...
            function () {
                ...
                echo '<p>' . sprintf(
                    __('<strong>%d</strong> activos de <strong>%d</strong> registrados.', 'convoca-members'),
                    esc_html($activos),
                    esc_html($total)
                ) . '</p>';
    ...
    public function handle_export_members_pdf(): void
    {
        ...
        $headers = [__('Nombre', 'convoca-members'), __('Email', 'convoca-members'), __('DNI', 'convoca-members'), __('Plan', 'convoca-members'), __('Estado', 'convoca-members'), __('Teléfono', 'convoca-members')];
        $rows = [];

...
class Voluntariado_Gamification
{
    ...
    const TRACKS = [
        'busgosu' => [
            ...
            'levels' => [
                ['name' => 'Semilla',    'emoji' => '🌱', 'hours' => 0,   'color' => '#7FA36B', 'desc' => 'Empiezas a conectar con la naturaleza'],
                ['name' => 'Brote',      'emoji' => '🌿', 'hours' => 10,  'color' => '#5C6B4F', 'desc' => 'Tus raíces crecen'],
                ['name' => 'Árbol',      'emoji' => '🌳', 'hours' => 25,  'color' => '#FF8700', 'desc' => 'Ya eres refugio de biodiversidad'],
                ['name' => 'Bosque',     'emoji' => '🌲', 'hours' => 50,  'color' => '#FFAB00', 'desc' => 'El ecosistema te reconoce'],
                ['name' => 'Ecosistema', 'emoji' => '🌍', 'hours' => 100, 'color' => '#7D0032', 'desc' => 'Eres parte del todo'],
            ],
        ],
        'lugg' => [
            'label'  => 'Lugg · Social',
            'levels' => [
                ['name' => 'Mano Abierta', 'emoji' => '🤝', 'hours' => 0,   'color' => '#4A90D9', 'desc' => 'El primer paso es la confianza'],
                ['name' => 'Vínculo',      'emoji' => '👥', 'hours' => 10,  'color' => '#357ABD', 'desc' => 'Creas comunidad'],
                ['name' => 'Comunidad',    'emoji' => '🏘️', 'hours' => 25,  'color' => '#E67E22', 'desc' => 'El grupo te sostiene'],
                ['name' => 'Ciudad',       'emoji' => '🌆', 'hours' => 50,  'color' => '#F39C12', 'desc' => 'Tu huella social se expande'],
                ['name' => 'Red',          'emoji' => '🌐', 'hours' => 100, 'color' => '#8E44AD', 'desc' => 'Eres nodo de una red viva'],
            ],
        ],
        'deva' => [
            'label'  => 'Deva · Elementales',
            'levels' => [
                ['name' => 'Náyade',     'emoji' => '💧', 'hours' => 0,   'color' => '#3498DB', 'desc' => 'Fluir con el cambio'],
                ['name' => 'Salamandra', 'emoji' => '🔥', 'hours' => 10,  'color' => '#E74C3C', 'desc' => 'La pasión que transforma'],
                ['name' => 'Silfo',      'emoji' => '🌪️', 'hours' => 25,  'color' => '#1ABC9C', 'desc' => 'La idea que vuela'],
                ['name' => 'Gnomo',      'emoji' => '⛰️', 'hours' => 50,  'color' => '#795548', 'desc' => 'La fuerza que sostiene'],
                ['name' => 'Deva',       'emoji' => '✨', 'hours' => 100, 'color' => '#9B59B6', 'desc' => 'Guardian/a de la naturaleza'],
            ],
        ],
    ];
    ...
    public static function get_track_for_member(int $member_id): string
    {
        ...
        foreach (['busgosu', 'lugg', 'deva'] as $track) {
    ...
    {
        register_rest_route(Rest_API::NAMESPACE, '/me/gamification', [
            'methods'             => 'GET',
            'callback'            => [__CLASS__, 'get_gamification_data'],
            'permission_callback' => [Rest_API::class, 'check_active_member'],
        ]);
    }

...
class Email_Manager
{
        ...
        $defaults = [
            ...
            'bienvenida' => [
                ...
                'body' => '<h1>¡Bienvenido/a a Biodevas, {nombre}! 🎉</h1>'
                    ...
                    . Email_Layout::meta_table([
                        ['label' => 'Nº Socio',  'value' => '{numero_socio}'],
                        ['label' => 'Plan',      'value' => '{plan}'],
                        ['label' => 'Estado',    'value' => '{estado}'],
                    ])
            ...
            'renovacion' => [
                ...
                'body' => '<h1>Hola {nombre},</h1>'
                    ...
                    . Email_Layout::meta_table([
                        ['label' => 'Plan actual',       'value' => '{plan}'],
                        ['label' => 'Cuota',             'value' => '{cuota}'],
                        ['label' => 'Fecha renovación',  'value' => '{fecha_renovacion}'],
                    ])
            ...
            'renovacion_automatica' => [
                ...
                'body' => '<h1>Hola {nombre},</h1>'
                    ...
                    . Email_Layout::meta_table([
                        ['label' => 'Plan',                     'value' => '{plan}'],
                        ['label' => 'Importe',                  'value' => '{importe}€'],
                        ['label' => 'Próxima renovación',       'value' => '{fecha_renovacion}'],
                    ])
            ...
            'renovacion_completada' => [
                ...
                'body' => '<h1>¡Buenas noticias, {nombre}! 🎉</h1>'
                    ...
                    . Email_Layout::meta_table([
                        ['label' => 'Nueva fecha renovación',  'value' => '{fecha_renovacion}'],
                    ])
            ...
            'voluntariado_recordatorio' => [
                ...
                'body' => '<h1>Hola {nombre},</h1>'
                    ...
                    . Email_Layout::meta_table([
                        ['label' => 'Horas registradas',       'value' => '{horas_actuales}h'],
                        ['label' => 'Objetivo anual',           'value' => '{horas_objetivo}h'],
                        ['label' => 'Progreso',                 'value' => '{porcentaje_cumplimiento}%'],
                    ])
            ...
            'objetivo_voluntariado_completado' => [
                ...
                'body' => '<h1>¡Enhorabuena, {nombre}! 🎉</h1>'
                    ...
                    . Email_Layout::meta_table([
                        ['label' => 'Horas completadas',       'value' => '{horas_totales}h'],
                        ['label' => 'Plan',                    'value' => '{plan_nombre}'],
                        ['label' => 'Proyectos',               'value' => '{proyectos_participados}'],
                    ])
     ...
     */
    public function send_credenciales(int $post_id, array $extra_vars = []): void
    {
    ...
    private function send(string $template_slug, int $post_id, array $extra_vars = []): void
    {
        ...
        $body = Email_Layout::render($body, $subject, [
            'footer_text' => sprintf(
